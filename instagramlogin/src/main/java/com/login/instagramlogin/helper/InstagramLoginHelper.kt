...
import com.login.instagramlogin.async.LoadRedirectUrlForInsta
...
object InstagramLoginHelper {
    ...
    class MyLoginListenerWebViewClient(
        val activity: Context,
        val dialogWeb: Dialog,
    ...
    fun startAsyncTaskForLogin(
        ...
        if (url.contains("code")) {
            ...
            val code = temp[1]
            LoadRedirectUrlForInsta(code, activity, dialogWeb, options).execute()
